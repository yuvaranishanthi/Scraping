...
plt.figure(figsize=(8, 6))
sns.scatterplot(x=x_test['Temperature'], y=y_test, label='Actual') # Changed X_test to x_test
sns.scatterplot(x=x_test['Temperature'], y=y_pred, label='Predicted') # Changed X_test to x_test
